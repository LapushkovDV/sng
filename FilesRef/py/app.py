...
dirpath = '/srv/fileservice-api/files/'
dirpathtmp = '/srv/fileservice-api/files/tmp/'
httpfileserver = 'http://10.20.62.103:8081'
pg_server = "10.20.62.107"
pg_user = "postgres"
pg_password = "Galaktika2000"
pg_database = "filestorage"
cryptokeypath = '/srv/fileservice-api/crypto.key'
...
@app.route('/fileservice/api/v1.0/deletefile/<file_uuid>', methods=['GET'])
